...
CREATE SEQUENCE suppliers_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE users_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE products_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE purchases_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE batches_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE inventory_movements_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE donations_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE waste_records_seq START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE alerts_seq START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE OR REPLACE TRIGGER trg_batches_bi
BEFORE INSERT ON batches
FOR EACH ROW
BEGIN
	IF :NEW.batch_id IS NULL THEN
		SELECT batches_seq.NEXTVAL INTO :NEW.batch_id FROM dual;
	END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_inventory_movements_bi
BEFORE INSERT ON inventory_movements
FOR EACH ROW
BEGIN
	IF :NEW.movement_id IS NULL THEN
		SELECT inventory_movements_seq.NEXTVAL INTO :NEW.movement_id FROM dual;
	END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_donations_bi
BEFORE INSERT ON donations
FOR EACH ROW
BEGIN
	IF :NEW.donation_id IS NULL THEN
		SELECT donations_seq.NEXTVAL INTO :NEW.donation_id FROM dual;
	END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_waste_records_bi
BEFORE INSERT ON waste_records
FOR EACH ROW
BEGIN
	IF :NEW.waste_id IS NULL THEN
		SELECT waste_records_seq.NEXTVAL INTO :NEW.waste_id FROM dual;
	END IF;
END;
/
