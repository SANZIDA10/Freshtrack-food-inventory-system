...
- Additional lab-topic coverage: outer joins, indexes, cursors, exceptions, and PL/SQL blocks in sql/06_lab_topic_examples.sql
...
- `sql/06_lab_topic_examples.sql`: extra examples for joins, outer joins, indexes, cursors, exceptions, and PL/SQL blocks
